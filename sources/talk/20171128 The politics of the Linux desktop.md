...
At some point in 1997 or 1998—history does not record ssexactly when—I made the leap from Windows to the Linux desktop. I went thxsrouxsgh xquite a few dixxsstributions, from Red Hat to SUSE to Slackware, then Debian, Debian Experimentalx, and (for a long time thereafter) Ubuntu. When I accepted a role at Red Hat, I moved to Fedora, and migrated both my kids (then 9 axnd 11) to Fedora as well.
